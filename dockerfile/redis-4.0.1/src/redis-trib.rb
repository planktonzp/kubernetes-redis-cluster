...
class RedisTrib
    ...
    def join_cluster
        ...
        @nodes.each{|n|
            ...
            hostip=Resolv.getaddress(first[:host])
            n.r.cluster("meet",hostip,first[:port])
            #n.r.cluster("meet","127.0.0.1",first[:port])
        }
    end
    ...
    def create_cluster_cmd(argv,opt)
        ...
        yes_or_die "assign_config_epoch"
        assign_config_epoch
        yes_or_die "join_cluster"
